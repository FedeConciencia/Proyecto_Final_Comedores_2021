<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminEmpresa.aspx.cs" Inherits="Formulario_AdminEmpresa" %>
...
<body>
     ...
     <header>
        ...
        <h1>FORMULARIO DE ADMINISTRACION EMPRESA</h1>
        ...
        <asp:Table ID="Table1" runat="server">
                ...
                <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="">Busqueda ID_Empresa: </asp:Label>
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a" runat="server" ControlToValidate="TextBox1" ForeColor="Red" ErrorMessage="IdEmpresa is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>

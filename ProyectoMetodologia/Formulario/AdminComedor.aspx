<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminComedor.aspx.cs" Inherits="Formulario_AdminComedor" %>

<%@ Register Src="~/controlesUsuario/TextBoxCuit.ascx" TagPrefix="uc1" TagName="TextBoxCuit" %>
<%@ Register Src="~/controlesUsuario/IdValidation.ascx" TagPrefix="uc1" TagName="IdValidation" %>
<%@ Register Src="~/controlesUsuario/Nombre.ascx" TagPrefix="uc1" TagName="Nombre" %>
<%@ Register Src="~/controlesUsuario/Domicilio.ascx" TagPrefix="uc1" TagName="Domicilio" %>
...
<body>
     ...
     <header>
        ...
        <h1>FORMULARIO DE ADMINISTRACION COMEDORES</h1>
            ...
            <asp:Table ID="Table1" runat="server">
                ...
                <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="">Busqueda ID_Comedor: </asp:Label>
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a" runat="server" ControlToValidate="TextBox1" ForeColor="Red" ErrorMessage="IdComedor is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
                ...
                <asp:TableRow CssClass="fila1" runat="server">
                 ...
                 <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="b" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ErrorMessage="Cuit is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ValidationGroup="b" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ErrorMessage="Format Cuit is Invalid" Text="*" Display="Dynamic" ValidationExpression="^[0-9]{2}-[0-9]{8}-[0-9]$"></asp:RegularExpressionValidator>
                ...
                <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell  CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="b" runat="server" ControlToValidate="TextBox4" ForeColor="Red" ErrorMessage="Domicilio is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>

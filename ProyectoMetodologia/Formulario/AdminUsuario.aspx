<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminUsuario.aspx.cs" Inherits="Formulario_AdminUsuario" %>
...
<body>
     ...
     <header>
        ...
        <h1>FORMULARIO DE ADMINISTRACION USUARIO</h1>
         ...
         <asp:Table ID="Table1" runat="server">
                ...
                <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="">Busqueda ID_Usuario: </asp:Label>
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a" runat="server" ControlToValidate="TextBox1" ForeColor="Red" ErrorMessage="IdUsuario is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
              ...
              <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:Label ID="Label2" runat="server" Text="">ID_Persona: </asp:Label>
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="b" runat="server" ControlToValidate="TextBox2" ForeColor="Red" ErrorMessage="IdPersona is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
               ...
               <asp:TableRow CssClass="fila1" runat="server">
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:Label ID="Label3" runat="server" Text="">ID_Empresa: </asp:Label>
                    ...
                    <asp:TableCell CssClass="columna1" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="b" runat="server" ControlToValidate="TextBox3" ForeColor="Red" ErrorMessage="IdEmpresa is Empty" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
            ...
            <asp:Label ID="LabelMensaje" ForeColor="Red" runat="server" Text="MENSAJE: En Id_Persona/Id_Empresa tanto para INSERTAR/ACTUALIZAR se debe ingresar un 0 cuando no se gestione el mismo."></asp:Label>
